...
"color: rgb(0, 0, 0);")
        ...
        self.dockWidget = QtWidgets.QDockWidget(Form_CargaDeTrabajo)
...
"background-color: rgb(255,255,255);")
    ...
    def retranslateUi(self, Form_CargaDeTrabajo):
        ...
        item.setText(_translate("Form_CargaDeTrabajo", "Tiempo"))
        item = self.tableWidget_Procesos.horizontalHeaderItem(1)
        item.setText(_translate("Form_CargaDeTrabajo", "Listo"))
        item = self.tableWidget_Procesos.horizontalHeaderItem(2)
        item.setText(_translate("Form_CargaDeTrabajo", "Bloqueado"))
        item = self.tableWidget_Procesos.horizontalHeaderItem(3)
        item.setText(_translate("Form_CargaDeTrabajo", "Ejecución"))
        item = self.tableWidget_Procesos.horizontalHeaderItem(4)
        item.setText(_translate("Form_CargaDeTrabajo", "Cola de Listos"))
        item = self.tableWidget_Procesos.horizontalHeaderItem(5)
        item.setText(_translate("Form_CargaDeTrabajo", "Cola de Entrada"))
        item = self.tableWidget_Procesos.horizontalHeaderItem(6)
        item.setText(_translate("Form_CargaDeTrabajo", "Cola de Salida"))
