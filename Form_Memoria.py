...
"color: rgb(0, 0, 0);")
        ...
        self.radioButton_PartVariables.setGeometry(QtCore.QRect(20, 180, 141, 17))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(8)
        font.setBold(True)
        ...
        self.spinBox_Particiones = QtWidgets.QSpinBox(Form_Memoria)
        self.spinBox_Particiones.setGeometry(QtCore.QRect(110, 110, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.spinBox_Particiones.setFont(font)
        self.spinBox_Particiones.setStyleSheet("color: rgb(255, 255, 255);")
        self.spinBox_Particiones.setAlignment(QtCore.Qt.AlignCenter)
        self.spinBox_Particiones.setMaximum(999)
        self.spinBox_Particiones.setObjectName("spinBox_Particiones")
        self.label_Particiones = QtWidgets.QLabel(Form_Memoria)
        self.label_Particiones.setGeometry(QtCore.QRect(10, 110, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.label_Particiones.setFont(font)
        self.label_Particiones.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_Particiones.setObjectName("label_Particiones")
        ...
        self.label_Particiones.raise_()
        self.spinBox_Particiones.raise_()
    ...
    def retranslateUi(self, Form_Memoria):
        ...
        self.radioButton_PartFijas.setToolTip(_translate("Form_Memoria", "First Come, First Served"))
        self.radioButton_PartFijas.setText(_translate("Form_Memoria", "Particiones Fijas"))
        self.radioButton_PartVariables.setToolTip(_translate("Form_Memoria", "First Come, First Served"))
        ...
        self.label_Particiones.setText(_translate("Form_Memoria", "Particiones"))
