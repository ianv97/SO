...
"color: rgb(0, 0, 0);")
        ...
        self.pushButton_Importar_2 = QtWidgets.QPushButton(Form_Memoria)
        self.pushButton_Importar_2.setGeometry(QtCore.QRect(20, 170, 141, 31))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.Window, brush)
        self.pushButton_Importar_2.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("12 MS Shell Dlg 2")
        font.setPointSize(8)
        font.setBold(True)
        font.setItalic(False)
        font.setWeight(75)
        self.pushButton_Importar_2.setFont(font)
        self.pushButton_Importar_2.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pushButton_Importar_2.setStyleSheet("background-color: rgb(0, 123, 255);\n"
"color: rgb(0, 0, 0);")
        self.pushButton_Importar_2.setAutoDefault(False)
        self.pushButton_Importar_2.setObjectName("pushButton_Importar_2")
        ...
        self.pushButton_Importar_2.raise_()
    ...
    def retranslateUi(self, Form_Memoria):
        ...
        self.pushButton_Importar_2.setToolTip(_translate("Form_Memoria", "<html><head/><body><p>Importar carga de trabajo</p></body></html>"))
        self.pushButton_Importar_2.setText(_translate("Form_Memoria", "Añadir Partición"))
