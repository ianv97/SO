...
class Ui_Dialog_Generar(object):
    def setupUi(self, Dialog_Generar):
        ...
        Dialog_Generar.resize(400, 220)
        Dialog_Generar.setMinimumSize(QtCore.QSize(400, 220))
        Dialog_Generar.setMaximumSize(QtCore.QSize(400, 220))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Recursos/Logo.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        Dialog_Generar.setWindowIcon(icon)
        Dialog_Generar.setStyleSheet("background-image:url(Recursos/Fondo.jpg)")
        Dialog_Generar.setModal(True)
...
"color: rgb(255, 255, 255);")
        ...
        self.label.setGeometry(QtCore.QRect(30, 40, 321, 21))
        font = QtGui.QFont()
